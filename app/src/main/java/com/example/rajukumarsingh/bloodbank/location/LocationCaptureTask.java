...
import java.util.List;
    ...
    public abstract class LocationCaptureTask extends AsyncTask<Void, Void, Location> {
        ...
        private com.example.rajukumarsingh.bloodbank.location.LocationClient locationClient;
        ...
        public LocationCaptureTask(Context context) {
            ...
            locationClient = new com.example.rajukumarsingh.bloodbank.location.LocationClient(context) {
